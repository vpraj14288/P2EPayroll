...
(function ($) {
    ...
    $.fn.gMapsLatLonPicker = (function () {
        ...
        _self.params = {
            defLat: 0,//http://localhost:50026/../../bin
            defLng: 0,
            defZoom: 1,
        ...
        var publicfunc = {
            ...
            init: function (object) {
                ...
                //resize map on modal shown otherwise will be empty
                $(_self.vars.cssID).parents('.modal').on('show.bs.modal', function () {
                    if (typeof _self.vars.map == "undefined") return;
                    setTimeout(function () {
                        if (typeof _self.vars.map == "undefined") return;
